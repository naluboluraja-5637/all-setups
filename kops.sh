...
kops create cluster --name rajasek.k8s.local --zones us-east-1a --image ami-05ffe3c48a9991133  --control-plane-count=1 --control-plane-size t2.large --node-count=2 --node-size t2.medium
kops update cluster --name rajasek.k8s.local --yes --admin
